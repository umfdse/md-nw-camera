    ...
    <!-- <div class="header">
      <div class="location">
        <el-breadcrumb separator="/">
          <el-breadcrumb-item class="location-other" :to="{ path: '/patient/list' }">患者管理</el-breadcrumb-item>
          <el-breadcrumb-item class="location-other" :to="{ path: '/patient/list',query:{patientId:$route.query.patientId}}">患者详情</el-breadcrumb-item>
