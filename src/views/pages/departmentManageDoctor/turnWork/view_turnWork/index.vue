    ...
    <div class="search_container searchArea">
      ...
      >
        <el-form-item class="btnLeft">
          ...
          <el-form-item class="btnLeft">
             <el-select v-model="search_data.shiftTimePeriod" clearable @change="typeChange">
            <el-option
    ...
    <div class="table_container">
      <el-table v-loading="loading"  :data="tableData" style="width: 100%">
       <div slot="empty" class="noData"></div>
        <el-table-column prop="shiftDate" label="交班日期" ></el-table-column>
        <el-table-column prop="shiftTimePeriod" label="交班班次" ></el-table-column>
...
export default {
  ...
  methods: {
    ...
    onView(row){
      this.$router.push({name:"departmentDetailDoctor",params:{newTime:row.shiftDate,shiftTimePeriod:row.shiftTimePeriod}})
    },
    onExport(row){
      console.log(row.templateUrl)
    ...
    loadData() {
      ...
      let param1 = {
        ...
        "shiftTimePeriod":this.search_data.shiftTimePeriod,
