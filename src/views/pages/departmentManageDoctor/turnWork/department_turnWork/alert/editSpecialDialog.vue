        ...
        <div class="form_departEdit">
            <el-form 
                ...
                <el-form-item prop='patientName' label="患者姓名:">
                 ...
                 <el-form-item prop='allergicHistory' label="过敏史:">
                    <el-input
                      type="textarea"
                      :rows="2"
                      placeholder="请输入"
                      v-model="ruleForm.allergicHistory"
                       :maxlength="200"
                       class="inputInner">
                    </el-input>
           ...
           this.form = this.dialogEditRow;
            ...
            this.ruleForm.patientName = this.form.patientName
             this.ruleForm.diagnosisContent = this.form.diagnosisContent
              this.ruleForm.allergicHistory = this.form.allergicHistory
          ...
          onSubmit(ruleForm){
            this.$refs[ruleForm].validate((valid) => {
              if(valid){
                let params = {
                  id:this.form.id,
                  diagnosisContent:this.ruleForm.diagnosisContent,
                ...
                let url = '/api/icu/transition/editDeptTransition'
