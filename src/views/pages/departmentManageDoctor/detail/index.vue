    ...
    <div class="header">
      <!-- <div class="location">
        <el-breadcrumb separator="/">
          <el-breadcrumb-item class="location-other" :to="{ path: '' }">科室管理</el-breadcrumb-item>
          <el-breadcrumb-item class="location-other" :to="{ path: '' }">交班管理</el-breadcrumb-item>
      ...
      <div class="contain_turnWork">
          <div class="department_header">
            <div class="department_history">
              ...
              <span class="text"> 科室交班历史记录({{newTime}})({{shiftTimePeriod}})</span>
             </div>
          ...
          <div class="table_container">
           ...
           <div class="tableThree">特殊病人交班</div>
            <div class="table_container">
...
<script>
  ...
  mounted() {
    ...
    this.shiftTimePeriod =  this.$route.params.shiftTimePeriod
    console.log(this.$route.params.newTime)
    this.loadData();
    this.getTotalData()
  },
  methods: {
    ...
    addUser() {
     ...
     getTotalData(){
      ...
      let params={
          ...
          shiftTimePeriod:this.$route.params.shiftTimePeriod,
          queryHistoryType:"1"
      }
    ...
    loadData() {
      ...
      let param1 = {
        shiftDate:this.$route.params.newTime,
        queryHistoryType:1,
        shiftClass:2,
        shiftTimePeriod:this.$route.params.shiftTimePeriod
      }
